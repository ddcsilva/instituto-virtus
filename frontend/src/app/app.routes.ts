...
export const routes: Routes = [
  ...
  //         path: 'pessoas',
  //         loadChildren: () =>
  //           import('./features/pessoas/pessoas.routes').then(
  //             (m) => m.PESSOAS_ROUTES
  //           ),
  ...
  //         path: 'cursos',
  //         loadChildren: () =>
  //           import('./features/cursos/cursos.routes').then(
  //             (m) => m.CURSOS_ROUTES
  //           ),
  //         canMatch: [roleGuard(['Admin', 'Coordenador'])],
  //       },
  ...
  //         path: 'turmas',
  //         loadChildren: () =>
  //           import('./features/turmas/turmas.routes').then(
  //             (m) => m.TURMAS_ROUTES
  //           ),
  ...
  //         path: 'presencas',
  //         loadChildren: () =>
  //           import('./features/presencas/presencas.routes').then(
  //             (m) => m.PRESENCAS_ROUTES
  //           ),
  //         canMatch: [roleGuard(['Admin', 'Coordenador', 'Professor'])],
  //       },
  //       {
  //         path: 'avaliacoes',
  //         loadChildren: () =>
  //           import('./features/avaliacoes/avaliacoes.routes').then(
  //             (m) => m.AVALIACOES_ROUTES
  //           ),
  //         canMatch: [roleGuard(['Admin', 'Coordenador', 'Professor'])],
  //       },
  //       {
